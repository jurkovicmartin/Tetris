...
Classis Tetris game done in Python with Pygame. I personally love the Tetris game, so as a project i made one myself. The main functionality was implemented with matrix, which represents the playing field, and operations on this matrix. The solution isn't optimal, especially the shapes rotating logic which was implemented on the principle of a finite state machine.
